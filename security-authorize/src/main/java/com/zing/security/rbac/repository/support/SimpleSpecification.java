...
public abstract class SimpleSpecification<T, C> extends AbstractEventConditionBuilder<T, C> implements Specification<T> {

    public SimpleSpecification(C condition) {
        super(condition);
    }
